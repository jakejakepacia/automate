...
export default function HomeScreen({ navigation }) {
  ...
  return (
    <ScrollView contentContainerStyle={{ paddingBottom: 100 }}>
      ...
      >
        <View
          style={[styles.header, { marginTop: insents.top }]}
          onLayout={(event) => {
      ...
      <View style={{ padding: 20 }}>
        ...
        >
          <Image source={promo1} style={styles.promoImg} resizeMode="stretch" />
          <Image source={promo2} style={styles.promoImg} resizeMode="stretch" />
        </ScrollView>
      </View>
      ...
      <View style={{ flexDirection: 'row', paddingInline: 20, gap: 20 }}>
        <TouchableOpacity
          style={[
            ...
            {
              backgroundColor:
                activeButton === 'forRent' ? Colors.primary : 'gray',
            },
          ]}
        ...
        <TouchableOpacity
          style={[
            ...
            {
              backgroundColor:
                activeButton === 'forSale' ? Colors.primary : 'gray',
            },
          ]}
