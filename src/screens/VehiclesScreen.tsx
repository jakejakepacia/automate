...
export default function VehiclesScreen({ navigation }) {
    ...
    function renderBooking({ item }: { item: any }) {
        ...
        return (
            <TouchableOpacity onPress={() => navigation.navigate("Details", { car: car })}>
                ...
                <View style={styles.info}>
                    <Text style={styles.title} numberOfLines={1}>
                        {car ? `${car.make} ${car.model} ${car.year || ''}` : `Car ID: ${item.car_id}`}
                    </Text>
        ...
        <SafeAreaView style={{flex: 1}}>
          <View style={styles.container}>
            <View style={styles.tabRow}>
                ...
                >
                    <Text style={tab === "renting" ? styles.tabTextActive : styles.tabText}>Renting</Text>
                </TouchableOpacity>
                <TouchableOpacity
                    style={[styles.tab, tab === "owned" ? styles.tabActive : null]}
                    onPress={handleOwnedCarPress}
                >
                    <Text style={tab === "owned" ? styles.tabTextActive : styles.tabText}>Owned</Text>
                </TouchableOpacity>
            </View>
...
const styles = StyleSheet.create({
    ...
    thumbPlaceholder: { width: 100, height: 80, borderRadius: 6, marginRight: 10, backgroundColor: "#eee" },
