...
export default function ScheduleScreen({ car, onClose, onBookingRequested }) {
  ...
  const calculateTotalWeeks = (days, pricePerDay, pricePerWeek) => {
    ...
    const totalPrice = weeks * pricePerWeek + remainingDays * pricePerDay
    return totalPrice
  }
  ...
  if (days < 7) {
    ...
    rentAmount = calculateTotalWeeks(
      days,
              ...
              <View style={{ flexDirection: 'row', gap: 10 }}>
                ...
                >
                  ...
                  <Text style={styles.priceText}>
                    {formatPHP(car?.car_pricing?.[0].price_per_day)}{' '}
                  </Text>
                </View>
                ...
                <View style={[styles.column, styles.priceContainer]}>
                  ...
                  <Text style={styles.priceText}>
                    {formatPHP(car?.car_pricing?.[0].price_per_week)}
                  </Text>
                </View>
                ...
                <View style={[styles.column, styles.priceContainer]}>
                  ...
                  <Text style={styles.priceText}>
                    {formatPHP(car?.car_pricing?.[0].price_per_month)}
                  </Text>
                </View>
              </View>
            </View>
              ...
              <View style={{ gap: 20 }}>
                <View style={styles.infoContainer}>
                  <View style={styles.column}>
                    ...
                    {startDate && endDate && (
                      <Text style={styles.info}>{getDayDifference()}</Text>
                    )}
                    {!startDate ||
                      (!endDate && <Text style={styles.info}>0</Text>)}
                  </View>
